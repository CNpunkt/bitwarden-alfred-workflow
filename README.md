...
## Version 1.3.2 update - Please Read

-----
* Added ctrl+option modifier to show the password within a popup
...
* Ctrl+option modifier can be used on `bw <query>` to show the password within a popup
...
* Version 1.3.2 - Added ctrl+option modifier to show the password within a popup
